...
namespace WebApp1._0.Controllers.User
{
  public class UserController : Controller
  {
    ...
    public ActionResult Index()
    {
      ...
      DataTable designation = sp.Sp_Generic_Class.GetMultipleRecord("Sp_getDesignation");
      obj.resultVal = designation;

      DataTable userDetails = sp.Sp_Generic_Class.GetMultipleRecord("Sp_GetUsersDetail");
      obj.resultView = userDetails;
      ...
      //  {
      //    zoneid = Convert.ToByte(row["zoneid"]),
    ...
    {
        DataTable userDet = new DataTable();
      try
      {
        var list = new Dictionary<string, object>();
        list.Add("userId", id);
         userDet = sp.Sp_Generic_Class.GetMultipleRecordByParam("Sp_GetUserDetailsOnId", list);
      ...
      return Json(new { obj_user = userDet }, JsonRequestBehavior.AllowGet);
    }
    public ActionResult DeleteUsers(int id)
    {
      var list = new Dictionary<string, object>();
      list.Add("userId", id);
      DataTable delUser = sp.Sp_Generic_Class.GetMultipleRecordByParam("Sp_DeleteUsersOnId", list);
